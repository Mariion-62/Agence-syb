    ...
    <SMentionLegals>
      ...
      <div className="mentionArticle">
        ...
        <p className="contentMentionArticle">
          ...
          et sans préavis par la société SYB GROUP. La société SYB GROUP ne
      ...
      <div className="mentionArticle">
        ...
        <p className="contentMentionArticle">
          ...
          <br />
          553 Bois d&apos;Achelles 59910 BONDUES
          <br />
      ...
      <div className="mentionArticle">
        ...
        <p className="contentMentionArticle">
          ...
          conséquence, la société SYB GROUP ne saurait être tenue responsable
          d’un quelconque dommage subi par l’ordinateur de l’utilisateur ou
          d’une quelconque perte de données consécutives au téléchargement. Les
          photos sont non contractuelles. Les liens hypertextes mis en place
          ...
          responsabilité de la société SYB GROUP.
        </p>
      </div>
      <div className="mentionArticle">
        ...
        <p className="contentMentionArticle">
          ...
          tribunaux dont dépend la société SYB GROUP. La langue de référence,
      ...
      <div className="mentionArticle">
        ...
        <p className="contentMentionArticle">
          ...
          droit de demande de retrait de leur(s) consentement(s) à l’utilisation
          des données collectées. Ce droit peut être exercé par voie postale
          auprès de la société SYB GROUP ou par voie électronique à l’adresse
          email suivante : hello@syb-group.fr Les informations personnelles
          collectées ne sont en aucun cas confiées à des tiers hormis pour
          l’éventuelle bonne exécution de la prestation commandée par
          l’internaute.
        </p>
      </div>
      <div className="mentionArticle">
        ...
        <p className="contentMentionArticle">
          ...
          de ce site internet, en ce compris notamment de son contenu, ses
          pages, ses textes et images, est interdit, sauf accord préalable et
          écrit de l’éditeur du site internet. De même, l’élaboration de liens
          hypertextes profonds vers le site internet https://www.syb-group.fr
          est interdite sauf accord préalable et écrit de l’éditeur du site
          internet. Le non-respect de ces interdictions est susceptible de
          constituer un acte de contrefaçon et/ou de concurrence déloyale.
        </p>
      </div>
      <div className="mentionArticle">
        <h3 className="titleMentionArticle">Crédits photos, icônes</h3>
        <p className="contentMentionArticle">SYB GROUP Adobe Stock Photos</p>
      </div>
      <div className="mentionArticle">
      ...
      <div className="mentionArticle">
        ...
        <p className="contentMentionArticle">
          La société SYB GROUP met en œuvre tous les moyens dont il dispose,
          ...
          auprès de la société SYB GROUP, et signaler toutes modifications du
          site qu’il jugerait utile. La société SYB GROUP n’est en aucun cas
      ...
      <div className="mentionArticle">
        ...
        <p className="contentMentionArticle">
          ...
          navigation. Certaines parties de ce site ne peuvent être fonctionnelle
          sans l’acceptation de cookies. Des cookies pour les statistiques du
          site via le service Google Analytics sont utilisés sur le site. Ces
          cookies permettent de mesurer de manière anonyme et agrégée l’audience
          des contenus présents sur le site et d’en améliorer le fonctionnement.
          Vous avez la possibilité d’exercer vos droits en matière de gestion
          des cookies via le bandeau affiché à la première visite. Il est
          également possible pour les utilisateurs du site d’exprimer leurs
          choix en matière de gestion des cookies directement à partir des
          paramètres de leur navigateur ou de leur OS. L’acceptation ou le refus
          des cookies via le bandeau affiché à la première visite du site est
          enregistré pour une durée d’1 an. Si vous continuez votre navigation
          sur le site, sans avoir manifesté votre acceptation ou refus des
          cookies via le bandeau, vous acceptez l’utilisation des cookies pour
          la durée de 6 mois.
        </p>
      </div>
      <div className="mentionArticle">
        ...
        <p className="contentMentionArticle">
          Le site internet de la société SYB GROUP peut offrir des liens vers
          d’autres sites internet ou d’autres ressources disponibles sur
          Internet. La société SYB GROUP ne dispose d’aucun moyen pour contrôler
          les sites en connexion avec ses sites internet. La société SYB GROUP
          ne répond pas de la disponibilité de tels sites et sources externes,
          ni ne la garantit. Elle ne peut être tenue pour responsable de tout
          ...
          Les utilisateurs, les abonnés et les visiteurs du site internet de la
          société SYB GROUP ne peuvent mettre en place un hyperlien en direction
          de ce site sans l’autorisation expresse et préalable de la société.
          Dans l’hypothèse où un utilisateur ou visiteur souhaiterait mettre en
          place un hyperlien en direction d’un des sites internet de la société
          SYB GROUP , il lui appartiendra d’adresser un email accessible sur le
          site afin de formuler sa demande de mise en place d’un hyperlien. La
          société SYB GROUP se réserve le droit d’accepter ou de refuser un
      ...
      <div className="mentionArticle">
        ...
        <p className="contentMentionArticle">
          ...
          information recherchée ne signifie en aucune façon que la société SYB
          GROUP reconnaît ou accepte quelque responsabilité quant à la teneur ou
          à l’utilisation du dit site.
        </p>
      </div>
      <div className="mentionArticle">
      ...
      <div className="mentionArticle">
        ...
        <p className="contentMentionArticle">
          ...
          Business apparaissent inexactes, il appartiendra au client de procéder
          lui-même à toutes vérifications de la cohérence ou de la vraisemblance
          des résultats obtenus. La société SYB GROUP ne sera en aucune façon
          responsable vis à vis des tiers de l’utilisation par le client des
          informations ou de leur absence contenues dans ses produits y compris
      ...
      <div className="mentionArticle">
        ...
        <p className="contentMentionArticle">
          La société SYB GROUP est à votre disposition pour tous vos
